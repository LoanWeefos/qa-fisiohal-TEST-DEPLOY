...
describe("TC104 — Ingresar como coordinación valores correctos en los campos de cada sección del componente de valoración inicial", function () {
  this.timeout(0);
  ...
  before(async () => {
    if (!global.__runningAll) {
      ...
      logger.info("\nEjecutando TC104 — Ingresar como coordinación valores correctos en los campos de cada sección del componente de valoración inicial | 104 de 105\n");
    }
