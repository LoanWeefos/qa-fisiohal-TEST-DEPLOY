...
describe("TC102 — Ingresar como terapeuta valores correctos en los campos de cada sección del componente de valoración inicial", function () {
  this.timeout(0);
  ...
  before(async () => {
    if (!global.__runningAll) {
      ...
      logger.info("\nEjecutando TC102 — Ingresar como terapeuta valores correctos en los campos de cada sección del componente de valoración inicial | 102 de 105\n");
    }
