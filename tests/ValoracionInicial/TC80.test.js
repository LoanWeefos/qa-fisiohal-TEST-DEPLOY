...
describe("TC80 — Validar campo ¿Ha notado que al levantarse rápidamente de una silla o cama siente mareo o aturdimiento?", function () {
  this.timeout(0);
  ...
  beforeEach(async () => {
    if (!global.__runningAll) {
      ...
      logger.info("\nEjecutando TC80 — Validar campo ¿Ha notado que al levantarse rápidamente de una silla o cama siente mareo o aturdimiento? | 80 de 105\n");
    }
  ...
  it("Comprobar elementos en el campo y solo elegir 1 elemento", async () => {
    ...
    const mareoSelect = await global.helper.findOrFail(
      ...
      "Campo mareo o aturdimiento al levantarse - No se encuentra en el formulario"
    );
    ...
    assert.deepStrictEqual(
      ...
      `Opciones incorrectas en mareo o aturdimiento al levantarse\nUI: ${JSON.stringify(uiOptions)}`
    );
