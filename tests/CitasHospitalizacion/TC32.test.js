...
describe("TC32 — Agendamiento semanal sin disponibilidad (Task de error)", function () {
  this.timeout(0);
  ...
  beforeEach(async () => {
    if (!global.__runningAll) {
      ...
      logger.info("\nEjecutando TC32 — Agendamiento semanal sin disponibilidad | 32 de 36\n");
    }
  ...
  it("Debe generar Task de error por falta de disponibilidad semanal", async () => {
