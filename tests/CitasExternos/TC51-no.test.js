...
describe("TC46 — Validar campo obligatorio Cantidad usada", function () {
  this.timeout(0);
  ...
  it("Debe mostrar error y no permitir avanzar sin capturar Cantidad usada", async () => {
    ...
    assert.ok(
      errorText.includes("Input is not optional"),
      "No se mostró el mensaje de error por Cantidad usada"
    );
  });
